...
//            VC.view.backgroundColor = UIColor.white
            ...
            navVC.tabBarItem.setTitleTextAttributes([NSAttributedStringKey.foregroundColor :UIColor.init(red: 0, green: 190, blue: 12, alpha: 1.0)], for: UIControlState.selected)
